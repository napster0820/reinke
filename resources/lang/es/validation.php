...
return [
    ...
    */
    'attributes'           => [
        ...
        'production'            => 'Producción estimada o (TonlHc):',
        'culture'               => 'Cultivo',

        'period'                => 'Periodo',
        'vl_irrigation_sys'     => 'Sistema de riego ($)',
        'vl_investment'         => 'Inversión cultivo ($)',
        'vl_energy'             => 'Energía ($)',
        'vl_maintenance'        => 'Mantenimiento ($)',
        'vl_entry'              => 'Ingreso ($)',
        'vl_liquidation'        => 'Liquidación ($)',
