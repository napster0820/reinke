...
// INSERT INTO `clients`( `id`, `client`, `address`, `country_state`, `email`, `production`, `culture`, `user_id`, `created_at`, `updated_at` ) VALUES( NULL, 'Corrales de Engorda de Tierra Blanca', 'Dom. Conocido Tierra Blanca', 'Veracruz', 'cliente1@gmail.com', 40, 40, 1, SYSDATE(), SYSDATE() );
