			...
			<ol type=”A”>
			  ...
			  <li>
			  	<p>
				  	...
				  	<br/>
				  	Será posible visualizarlo después que se realiza el login o registro de usuario y se cargan los datos del clientes en el formulário accedido por el link <a href="<?php echo e(url("datos")); ?>") }}>Nuevo Dashboard</a>. 
				  	<br/>
				  	También puedes visualizar los que ya fueron generados por en link <a href="<?php echo e(url("historial")); ?>") }}>Consultar Dashboards</a>.
				</p>
			  </li>
			  <li>
			  	<p>
				  	...
				  	<br/>
				  	Es posible generarlo por el link <a href="<?php echo e(url("historial")); ?>") }}>Consultar Dashboards</a>. 
				</p>
			  </li>		
			  <li>
			  	<p>
			  ...
			  <li>
			  	<p>
				  	...
				  	<br/>
				  	Busque el registro por en el <a href="<?php echo e(url("historial")); ?>") }}>Consultar Dashboards</a> y seleccione el botón de edición.
				</p>
			  </li>				  
			</ol>
		</div>
