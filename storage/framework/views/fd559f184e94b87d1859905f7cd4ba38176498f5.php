        ...
        <div class="row">
            <div class="col-3">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="card-text"><b>Cliente:</b> <?php echo e($client->name ?? 'Teste'); ?> </p>
                        <p class="card-text"><b>Dirección:</b> <?php echo e($client->address ?? 'Teste'); ?></p>
                        <p class="card-text"><b>Estado:</b> <?php echo e($client->country_state ?? 'Teste'); ?></p>
                        <p class="card-text"><b>Producción estimada:</b> <?php echo e($client->production ?? 'Teste'); ?></p>
                        <p class="card-text"><b>Cultivo:</b> <?php echo e($client->culture ?? 'Teste'); ?> </p>
                    </div>
                </div>
                <br>
                <!--div class="card">
