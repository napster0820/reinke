...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="<?php echo e(url("datos")); ?>"><img src="<?php echo e(URL::asset('images/reinke_logo.png')); ?>" alt="reinke_logo"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarText">
          ...
          <span class="navbar-text">
            <a href="<?php echo e(url('datos')); ?>"><strong>Nuevo Dashboard</strong></a>
          </span>
          <!--span class="navbar-text">
              <a href="<?php echo e(url('dashboard')); ?>"><strong>Dashboard</strong></a>
          </span-->
          <span class="navbar-text">
            <a href="<?php echo e(url('historial')); ?>"><strong>Consultar Dashboards</strong></a>
          </span>
          <span class="navbar-text">
